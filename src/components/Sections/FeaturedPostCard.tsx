...
import { IFeaturedPost, IIPostsResponse } from '@/interfaces/interfaces';
...
export default function FeaturedPostCard ({ title,featuredImage,author,createdAt,slug }:  IFeaturedPost){
  return (
    ...
    <div className="absolute rounded-lg bg-center bg-no-repeat bg-cover shadow-md inline-block w-full h-72" style={{ backgroundImage: `url('${featuredImage.url}')` }} />
